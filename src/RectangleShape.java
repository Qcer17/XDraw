...
public class RectangleShape extends Shape{
	...
	private void drawRectangle(Graphics g) {
		pointsOnFrame.clear();
		for(int i=0;i<4;i++) {
			LineShape.drawLine(g, x[i%4], y[i%4], x[(i+1)%4], y[(i+1)%4],true,pointsOnFrame);
		}
	}
	...
	public RectangleShape(int x1,int y1, int x2,int y2,Color color,Color color2, PaintArea paintArea) {
		super();
